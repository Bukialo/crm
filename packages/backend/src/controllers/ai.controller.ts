...
export class AiController {
  ...
  // Procesar consulta de IA - CORREGIDO: Return type Promise<void>
  ...
  // Obtener historial de chat - CORREGIDO: Removido limit no usado
  getChatHistory = asyncHandler(
    async (_req: Request, res: Response): Promise<void> => {
      // Removido limit ya que no se usa
  ...
  // Obtener insights automáticos - CORREGIDO: Agregado underscore para req no usado
  getInsights = asyncHandler(
    async (_req: Request, res: Response): Promise<void> => {
      try {
  ...
  // Obtener sugerencias contextuales - CORREGIDO: Removido context no usado
  getSuggestions = asyncHandler(
    async (_req: Request, res: Response): Promise<void> => {
      // Removido context ya que no se usa
